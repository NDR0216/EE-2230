...
set_property PACKAGE_PIN R2 [get_ports {d[7]}]
set_property PACKAGE_PIN T1 [get_ports {d[6]}]
set_property PACKAGE_PIN U1 [get_ports {d[5]}]
set_property PACKAGE_PIN W2 [get_ports {d[4]}]
